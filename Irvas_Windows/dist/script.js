...
/* harmony import */ var _checkNumImput__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkNumImput */ "./src/js/modules/checkNumImput.js");
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNumImput__WEBPACK_IMPORTED_MODULE_1__["default"])('#width');
  Object(_checkNumImput__WEBPACK_IMPORTED_MODULE_1__["default"])('#height');
    ...
    elem.forEach(function (item, i) {
      item.addEventListener(event, function () {
        switch (item.nodeName) {
          ...
          default:
            Error.throw("Unknown element - ".concat(item.nodeName));
            break;
        }
...
/***/ "./src/js/modules/checkNumImput.js":
/*!*****************************************!*\
  !*** ./src/js/modules/checkNumImput.js ***!
  \*****************************************/
/*! exports provided: default */
...
/* harmony import */ var _checkNumImput__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./checkNumImput */ "./src/js/modules/checkNumImput.js");
...
var forms = function forms(state) {
  ...
  Object(_checkNumImput__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]');
  var message = {
    loading: 'Загрузка',
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  header.addEventListener('click', function (_ref) {
    ...
    var classNameWithoutDot = tabSelector.replace(/\./, '');

    if (target && target.classList.contains(classNameWithoutDot) || target.parentNode.classList.contains(classNameWithoutDot)) {
